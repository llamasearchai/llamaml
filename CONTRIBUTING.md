# Contributing to LlamaMl

Thank you for your interest in contributing to LlamaMl! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaMl:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamaml.git
   cd llamaml
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamaml.git
   ```
...
By contributing to LlamaMl, you agree that your contributions will be licensed under the project's MIT License.
